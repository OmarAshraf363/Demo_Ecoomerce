...
namespace Demo.Migrations
{
    ...
    public partial class ReCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "BrandId", "CategoryId", "Image", "ListPrice", "ModelYear", "ProductDescription", "ProductName", "Rate" },
                values: new object[,]
                {
                    { 3, 2, 2, "smartphone.jpg", 999.99m, (short)2023, "Latest model with advanced features.", "Smartphone", 5 },
                    { 4, 3, 3, "jeans.jpg", 49.99m, (short)2022, "Comfortable and stylish jeans.", "Jeans", 4 },
                    { 5, 4, 4, "novel.jpg", 19.99m, (short)2021, "Bestselling novel by a famous author.", "Novel", 4 }
                });

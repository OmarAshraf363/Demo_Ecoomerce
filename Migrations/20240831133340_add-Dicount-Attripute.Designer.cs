...
namespace Demo.Migrations
{
    ...
    [Migration("20240831133340_add-Dicount-Attripute")]
    partial class addDicountAttripute
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demo.Models.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Demo.Models.WishListItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Demo.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "123548458",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1c486807-84ab-493d-9344-a67088096b33",
                            Email = "Admin@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEG+QzPP5L9R1w+xHf7wIjm1oxVK+j0NZCH1lvKWTGdlNKSMyEc2Bo8W6oxqNHFns8A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8df9e361-81f6-4c27-87b0-91ea4d6a29d7",
            ...
            modelBuilder.Entity("Demo.Models.WishList", b =>
                {
                    b.HasOne("Demo.Models.AppUser", "AppUser")
                        .WithOne("WishList")
                        .HasForeignKey("Demo.Models.WishList", "AppUserId");
            ...
            modelBuilder.Entity("Demo.Models.WishListItems", b =>
                {
                    ...
                    b.HasOne("Demo.Models.WishList", "WishList")
                        .WithMany("WishListItems")
